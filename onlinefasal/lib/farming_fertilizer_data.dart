          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                (language=='Hindi')? buildFutureBuilderhead(fertilizerP.fertilizers[data].trade_name, 'hi'):Text(
                    fertilizerP.fertilizers[data].trade_name,style: TextStyle(
                ...
                Row(
                  ...
                  children:  [
                    Expanded(
                      child: (language=='Hindi')?buildFutureBuildersubhead("Cycle",'hi'): Text(
                        "Cycle",style: TextStyle(
                          color: Colors.teal,
                          fontSize: 17.0,
                          fontWeight: FontWeight.bold),
                      ),
                ...
                Row(
                  ...
                  children:  [
                    Expanded(
                      child: (language=='Hindi')?buildFutureBuilder(fertilizerP.fertilizers[data].cycle,'hi'):Text(
                        fertilizerP.fertilizers[data].cycle,
                        style: const TextStyle(fontSize: 15),
                      ),
                    ),
                  ],
                ...
                Row(
                  ...
                  children:  [
                    Expanded(
                      child: (language=='Hindi')?buildFutureBuildersubhead("Amount",'hi'): Text(
                ...
                Row(
                  ...
                  children:  [
                    Expanded(
                      child: (language=='Hindi')?buildFutureBuilder(fertilizerP.fertilizers[data].amount,'hi'):Text(
                        fertilizerP.fertilizers[data].amount,
                        style: const TextStyle(fontSize: 15),
                      ),
                    ),
                  ],
                ...
                Row(
                  ...
                  children:  [
                    Expanded(
                      child: (language=='Hindi')?buildFutureBuilder(fertilizerP.fertilizers[data].state,'hi'):Text(
                        fertilizerP.fertilizers[data].state,
                        style: const TextStyle(fontSize: 15),
                      ),
                    ),
                  ],
