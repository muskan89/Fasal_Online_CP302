...
class _ChatCerealsScreenState extends State<ChatCerealsScreen> {
        ...
        children: <Widget>[
          ...
          Column(children: <Widget>[
            Row(
              ...
              children: [
                Expanded(
                  child: (language == 'Hindi') ? Text('अनाज के नाम',style: TextStyle(
            ...
            ListTile(
              ...
              title: (language == 'Hindi') ? buildFutureBuildertr(
                  "Maize(Kharif)", 'hi') :  Text('Maize(Kharif)'),
            ),
            // Row(
            //   mainAxisAlignment: MainAxisAlignment.spaceBetween,
            //   children: const [
  ...
  Column buildColumn(int selectedQueryType, int selectedcereals) {
    return Column(
