            ...
            children: <Widget>[
              ...
              Column(children: <Widget>[
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Text("How can I help you? Please select category from the given options",
                          style: TextStyle(
                              color: Color.fromRGBO(0, 0, 0, 1.0),
                              fontSize: 15.0)),
                    ),
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: FlatButton(
                        child: Text('Weather', style: TextStyle(fontSize: 20.0),),
                        color: Colors.orange,
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(100, 10, 20, 10),
                      child: FlatButton(
                        child: Text('Mandi Rate', style: TextStyle(fontSize: 20.0),),
                        color: Colors.brown,
                        textColor: Colors.white,
                        onPressed: () {
                          Navigator.of(context).push(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(100, 10, 20, 10),
                      child: FlatButton(
                        child: Text('Vegetables', style: TextStyle(fontSize: 20.0),),
                        color: Colors.teal,
                        textColor: Colors.white,
                        onPressed: () {
                          Navigator.of(context).push(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(100, 10, 20, 10),
                      child: FlatButton(
                        child: Text('Spices', style: TextStyle(fontSize: 20.0),),
                        color: Colors.red,
                        textColor: Colors.white,
                        onPressed: () {
                          Navigator.of(context).push(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(100, 10, 20, 10),
                      child: FlatButton(
                        child: Text('Schemes', style: TextStyle(fontSize: 20.0),),
                        color: Colors.blue,
                        textColor: Colors.white,
                        onPressed: () {
                          Navigator.of(context).push(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(100, 10, 20, 10),
                      child: FlatButton(
                        child: Text('Communication', style: TextStyle(fontSize: 20.0),),
                        color: Colors.black,
                        textColor: Colors.white,
                        onPressed: () {
                          Navigator.of(context).push(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(100, 10, 20, 10),
                      child: FlatButton(
                        child: Text('Fruits', style: TextStyle(fontSize: 20.0),),
                        color: Colors.orange,
                        textColor: Colors.white,
                        onPressed: () {
                          Navigator.of(context).push(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(100, 10, 20, 10),
                      child: FlatButton(
                        child: Text('Cereals', style: TextStyle(fontSize: 20.0),),
                        color: Colors.green,
                        textColor: Colors.white,
                        onPressed: () {
                          Navigator.of(context).push(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(100, 10, 20, 10),
                      child: FlatButton(
                        child: Text('Oilseeds', style: TextStyle(fontSize: 20.0),),
                        color: Colors.grey,
                        textColor: Colors.white,
                        onPressed: () {
                          Navigator.of(context).push(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(100, 10, 20, 10),
                      child: FlatButton(
                        child: Text('Pulses', style: TextStyle(fontSize: 20.0),),
                        color: Colors.teal,
                        textColor: Colors.white,
                        onPressed: () {
                          Navigator.of(context).push(
