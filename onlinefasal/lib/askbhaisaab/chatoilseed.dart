...
class _ChatOilseedScreenState extends State<ChatOilseedScreen> {
  ...
  Column buildColumn(int selectedoilseed, int selectedQueryType) {
    return Column(
