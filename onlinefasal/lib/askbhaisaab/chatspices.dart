        ...
        children: <Widget>[
          ...
          Column(children: <Widget>[
            Row(
              ...
              children:  [
                Expanded(
                  child: (language == 'Hindi') ? Text("मसालों के नाम",style: TextStyle(
