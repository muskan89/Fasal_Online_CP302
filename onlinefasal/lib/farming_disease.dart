      ...
      body: ListView(children: <Widget>[
                  ...
                  Expanded(
                    child: InkWell(
                      ...
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => FarmingDiseaseScreen(data: data)),
                        );
                      },
                    ),
                  ),
        ...
        ConstrainedBox(
            ...
            child: ListView.builder(
                itemCount: diseaseP.diseases.length,
                itemBuilder: (BuildContext context, int index) {
                  return
                      //ListTile(
                      (diseaseP.diseases[index].crop == data)
                          ? InkWell(
                              child: Container(
                                  height: 80,
                                  padding:
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      (diseaseP.diseases[index].disease_image
                                                  .toString()
                                                  .isEmpty ||
                                              diseaseP.diseases[index]
                                                      .disease_image
                                                      .toString() ==
                                                  ",")
                                          ? const Padding(
                              ...
                              onTap: () {
                                ...
                                Navigator.of(context).push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        FarmingDiseaseScreendata(data: index),
                                  ),
                                );
                                // Navigator.push(
                                //     context,
