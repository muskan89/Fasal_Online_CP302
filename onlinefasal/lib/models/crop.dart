...
class Crop {
  ...
  factory Crop.fromJson(Map<String, dynamic> json) {
    return Crop(
      ...
      description:
          (json['description'] != null) ? json['description'] : "Not available",
      ...
      botanical_name: (json['botanical_name'] != null)
          ? json['botanical_name']
          : "Not available",
      ...
      rotations:
          (json['rotations'] != null) ? json['rotations'] : "Not available",
      cropimage:
          (json['cropimage'] != null) ? json['cropimage'] : "Not available",
      average_yield: (json['average_yield'] != null)
          ? json['average_yield']
          : "Not available",
