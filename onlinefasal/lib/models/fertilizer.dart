...
class Fertilizer {
  ...
  Fertilizer(
      ...
      required this.amount_min,
      required this.amount_max});
  ...
  factory Fertilizer.fromJson(Map<String, dynamic> json) {
    return Fertilizer(
        ...
        trade_name:
            (json['trade_name'] != null) ? json['trade_name'] : "Not available",
        cycle: (json['cycle'] != null) ? json['cycle'] : "Not available",
        amount: (json['amount'] != null) ? json['amount'] : "Not available",
        amount_min:
            (json['amount_min'] != null) ? json['amount_min'] : "Not available",
        amount_max: (json['amount_max'] != null)
            ? json['amount_max']
            : "Not available");
  }
}
