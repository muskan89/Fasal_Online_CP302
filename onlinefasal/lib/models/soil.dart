...
class Soil {
  ...
  Soil(
      ...
      required this.state,
      required this.type,
      required this.water_content,
      required this.ph,
      required this.water_content_min,
      required this.water_content_max,
      required this.ph_min,
      required this.ph_max});
  ...
  factory Soil.fromJson(Map<String, dynamic> json) {
    return Soil(
        ...
        water_content: (json['water_content'] != null)
            ? json['water_content']
            : "Not available",
        ph: (json['ph'] != null) ? json['ph'] : "Not available",
        water_content_min: (json['water_content_min'] != null)
            ? json['water_content_min']
            : -1,
        water_content_max: (json['water_content_max'] != null)
            ? json['water_content_max']
            : -1,
